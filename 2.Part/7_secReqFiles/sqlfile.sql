...
INSERT INTO `packagings` VALUES (1,'Gorgan');
INSERT INTO `packagings` VALUES (2,'Isfahan');
INSERT INTO `packagings` VALUES (3,'Tehran');


CREATE TABLE `orders` (
  `order_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `packaging_id` int(11) NULL,
  `date_of_order` date NOT NULL,
  PRIMARY KEY (`order_id`),
  CONSTRAINT `fk_orders_customers` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_orders_packagings` FOREIGN KEY (`packaging_id`) REFERENCES `packagings` (`packaging_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
INSERT INTO `orders` VALUES (1,5,1,'2020-04-01');
INSERT INTO `orders` VALUES (2,4,1,'2020-04-01');
INSERT INTO `orders` VALUES (3,5,3,'2020-04-01');
INSERT INTO `orders` VALUES (4,5,Null,'2020-04-01');
INSERT INTO `orders` VALUES (5,2,Null,'2020-04-01');
INSERT INTO `orders` VALUES (6,1,1,'2020-04-01');
